...
public class UserCenterEvaluateFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener{
    ...
    public UserCenterEvaluateFragment() {
    ...
    public void onEventMainThread(HomeFloatLayerEvent event) {
        ...
        hideLoadingProgress();
        L.d(OkHttpExecutor.TAG, "onEventMainThread-UserCenterEvaluateFragment>" + event.getData().getActivityEnable());
